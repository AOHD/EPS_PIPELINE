...
hitlist <- c(c("*E. faecalis* PS", "Emulsan", "Unclassified cellulose", "Stewartan", "HA (has)"), "Galactoglucan", "Acetylated cellulose", "Pel", "Cellulose III",  "Colanic Acid", "Alginate", "Methanolan", "Acetan", "Amylovoran", "Succinoglycan", "Levan", "*Vibrio* EPS", "HA (pmHAS)", "Synechan", "S88", "Diutan", "Gellan 2",  "PNAG (pga)", "*B. subtilis* EPS", "GG", "*Burkholderia* EPS", "*B. fragilis* PS B", "Cellulose II", "Xanthan", "Salecan", "Psl", "*L. plantarum* PS", "Cepacian", "*B. fragilis* PS A", "Glucorhamnan")
...
ggsave("/mnt/ahd/EPS_PIPELINE/figures/upset/upset_ProkkaNO.pdf", upset_all, limitsize = FALSE, width = 14, height = 16, dpi = 300)
