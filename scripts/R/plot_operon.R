...
<<<<<<< HEAD
  domain_colors <- c("#696969", "#8b0000", "#008000", "#7f007f",
                     "#ff0000", "#ff8c00", "#ffff00", "#7cfc00",
                     "#40e0d0", "#00fa9a", "#4169e1", "#e9967a",
                     "#00bfff", "#0000ff", "#ff00ff", "#f0e68c",
                     "#dda0dd", "#ff1493" )
=======
  domain_colors <- c("#2f4f4f", "#8b4513", "#006400", "#ffdead",
                     "#ff4500", "#ffd700", "#7fff00", "#00bfff",
                     "#0000ff", "#ff00ff", "#dda0dd", "#ff1493",
                     "#7fffd4", "#ffdead", "#ffdead", "#ffdead",
                     "#ffdead", "#ffdead")
>>>>>>> af8b19357f741f4e310eeb23e8265917d947a18a
