...
parallel -j5 rsem-calculate-expression --paired-end --bowtie2 --bowtie2-sensitivity-level sensitive -p 10 \
/projects/glomicave/metatranscriptomics/01_mRNA_processed/processing_ribodetector/mRNA/{}_R1.fastq \
/projects/glomicave/metatranscriptomics/01_mRNA_processed/processing_ribodetector/mRNA/{}_R2.fastq \
